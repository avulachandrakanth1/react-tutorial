    ...
    <nav className="navbar navbar-expand-lg bg-success ">
      <div className="container-fluid justify-content-center">
        <Link to="/" className="navbar-brand text-light d-flex">
          <svg className="mt-2" 
            height="40"
            viewBox="30.628 53.519 537.802 493.016"
            width="40"
